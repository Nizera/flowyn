            ...
            <div className="flex gap-3 mb-5">
              <div className="flex-1">
                ...
                <input
                  ...
                  className="w-full px-3 py-2 text-sm border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 bg-background text-foreground"
                />
              </div>
              <div className="flex-1">
