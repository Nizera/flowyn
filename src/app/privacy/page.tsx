      ...
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="prose prose-gray max-w-none space-y-8">
          ...
          <section>
            ...
            <p className="text-muted leading-relaxed mb-3">Coletamos os seguintes tipos de dados:</p>
          ...
          <section>
            ...
            <p className="text-muted leading-relaxed mb-3">Utilizamos seus dados para:</p>
            <ul className="list-disc list-inside text-muted space-y-2 ml-4">
          ...
          <section>
            ...
            <p className="text-muted leading-relaxed mb-3">Conforme a LGPD, você tem direito a:</p>
            <ul className="list-disc list-inside text-muted space-y-2 ml-4">
