  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <p className="text-sm text-muted mb-8">Última atualização: 09 de julho de 2026</p>
        ...
        <div className="prose prose-gray max-w-none space-y-8">
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mb-3">6. Produtos Digitais</h2>
            <p className="text-muted leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mb-3">7. Integrações com Plataformas de Anúncios</h2>
            <p className="text-muted leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mb-3">10. Suspensão e Cancelamento</h2>
            <p className="text-muted leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mb-3">12. Foro</h2>
            <p className="text-muted leading-relaxed">
